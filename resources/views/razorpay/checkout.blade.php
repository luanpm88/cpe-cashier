                ...
                <div class="hide" style="display:none">
                    ...
                    'invoice_uid' => $invoice->uid,
                        ...
                        <script
                            ...
                            {{-- data-image="{{ \App\Models\Setting::get('site_logo_small') ? \Acelle\Cashier\Cashier::lr_action('SettingController@file', \App\Models\Setting::get('site_logo_small')) : URL::asset('images/default_site_logo_small_' . (Auth::user()->account->getColorScheme() == "white" ? "dark" : "light") . '.png') }}" --}}
                            data-prefill.email="{{ $invoice->account->user->email }}"
